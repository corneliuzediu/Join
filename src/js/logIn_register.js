 ...
 * @param {string} newEmail - Value corresponding to the email given by the new user.
 ...
 * @param {integer} indexReset - The value is coresponding to the index of the user.
 */
